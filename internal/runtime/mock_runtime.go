...
func (m *MockRuntime) Flavor() string {
	m.ctrl.T.Helper()
...
func (mr *MockRuntimeMockRecorder) Flavor() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Flavor", reflect.TypeOf((*MockRuntime)(nil).Flavor))
}
