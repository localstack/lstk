...
- PR descriptions follow the Issue / Solution / Docs / Review structure (template in the `/create-pr` skill): a high-level description of the issue or feature, a solution summary a reviewer can thumbs-up or -down, and a Docs section technical writers triage from — always present, stating explicitly when there is nothing to document.
