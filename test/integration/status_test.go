...
func TestStatusCommandShowsResourcesWhenRunning(t *testing.T) {
	...
	require.Contains(t, stdout, "SQS")
	require.Contains(t, stdout, "my-test-queue")
...
func TestStatusCommandWorksWithNonDefaultPort(t *testing.T) {
	...
	require.NoError(t, err, "lstk status failed: %s", stderr)
	require.Contains(t, stdout, "4.14.1")
}
...
func TestStatusCommandWorksWithExternalContainer(t *testing.T) {
	...
	requireExitCode(t, 0, err)
	require.Contains(t, stdout, "3.5.0")
}
...
func TestStatusCommandForSnowflakeShowsNoResources(t *testing.T) {
	...
	require.Contains(t, stdout, "running")
	require.Contains(t, stdout, "snowflake.localhost.localstack.cloud:4566",
	...
	require.NotContains(t, stdout, "SERVICE")
	require.NotContains(t, stdout, "No resources deployed")
}
...
func TestStatusCommandForSnowflakeShowsVersion(t *testing.T) {
	...
	require.Contains(t, stdout, "• Version: "+expectedVersion,
...
func TestStatusCommandShowsNoResourcesWhenEmpty(t *testing.T) {
	...
	require.NoError(t, err, "lstk status failed: %s", stderr)
	requireExitCode(t, 0, err)
	require.Contains(t, stdout, "No resources deployed")
}
